...
const About = () => {
  return (
    <Card>
        <Card.Title  className={classes.title}>About</Card.Title>
        <Stack direction='horizontal' gap={3}>
        <Card.Img src='https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png' className={classes['card-image']}/>
        <Card.Text>
